...
public:
  RendererX11 (unsigned int width = 800, unsigned int height = 600,
               const Rgb &background = rgb_white, Display *disp = 0,
               int src = -1, Window win = -1, GC gc = 0);
...
double
RendererX11::y_trans_pos (double y) const
{
...
math::Vector2
RendererX11::trans_pos (const math::Vector2 &v)
{
