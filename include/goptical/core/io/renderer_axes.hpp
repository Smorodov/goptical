...
public:
  ...
  /** @This sets distance between axis tics to best fit power of
      ...
      set_tics_count} */
  void set_tics_base (unsigned int min_count = 5, double base = 10.0,
                      AxisMask a = XYZ);
...
const math::Vector3 &
RendererAxes::get_position () const
{
  return _pos;
}

const math::Vector3 &
RendererAxes::get_origin () const
{
  return _origin;
}

bool
RendererAxes::get_show_grid () const
{
  return _grid;
}

bool
RendererAxes::get_show_frame () const
{
  return _frame;
}

bool
RendererAxes::get_show_axes (unsigned int i) const
{
  return _axes[i]._axis;
}

bool
RendererAxes::get_show_tics (unsigned int i) const
{
  return _axes[i]._tics;
}

bool
RendererAxes::get_show_values (unsigned int i) const
{
  return _axes[i]._values;
}

const std::string &
RendererAxes::get_label (unsigned int i) const
{
