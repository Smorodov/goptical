...
public:
  ...
  */
  ...
  inline void set_metrics (const math::Vector2 &origin,
  ...
  inline const math::Vector2 &get_d_value (unsigned int n1,
  ...
  double interpolate (const double x[], unsigned int deriv,
...
private:
  ...
  double interpolate_nearest_y (const unsigned int x[2],
                                const math::Vector2 &v) const;
  double interpolate_linear_y (const unsigned int x[2],
                               const math::Vector2 &v) const;
  double interpolate_bicubic_y (const unsigned int x[2],
                                const math::Vector2 &v) const;

  void interpolate_nearest_d (const unsigned int x[2], math::Vector2 &d,
                              const math::Vector2 &v) const;
  void interpolate_linear_d (const unsigned int x[2], math::Vector2 &d,
                             const math::Vector2 &v) const;
  void interpolate_bicubic_d (const unsigned int x[2], math::Vector2 &d,
                              const math::Vector2 &v) const;
  ...
  template <int v>
  void get_deriv_smooth (math::Vector2 d[], unsigned int w,
  ...
  double (Grid::*_interpolate_y) (const unsigned int x[2],
                                  const math::Vector2 &v) const;
  void (Grid::*_interpolate_d) (const unsigned int x[2], math::Vector2 &d,
                                const math::Vector2 &v) const;
...
math::Vector2
Grid::get_x_value_i (unsigned int n1, unsigned int n2) const
{
  return _origin + _step.mul (math::Vector2 ((double)n1, (double)n2));
}

double
Grid::get_y_value (unsigned int n1, unsigned int n2) const
{
  assert (n1 < _size[0]);
  assert (n2 < _size[1]);
...
double &
Grid::get_y_value (unsigned int n1, unsigned int n2)
{
  assert (n1 < _size[0]);
  assert (n2 < _size[1]);
...
const math::Vector2 &
Grid::get_d_value (unsigned int n1, unsigned int n2) const
{
...
math::Vector2 &
Grid::get_d_value (unsigned int n1, unsigned int n2)
{
  assert (_interpolation == BicubicDeriv);
  assert (n1 < _size[0]);
  assert (n2 < _size[1]);
...
double
Grid::get_nearest_y (const math::Vector2 &v) const
{
  unsigned int x[2];
...
const math::Vector2 &
Grid::get_nearest_d (const math::Vector2 &v) const
{
  assert (_interpolation == BicubicDeriv);
...
double &
Grid::get_nearest_y (const math::Vector2 &v)
{
  unsigned int x[2];
...
math::Vector2 &
Grid::get_nearest_d (const math::Vector2 &v)
{
  assert (_interpolation == BicubicDeriv);
...
double
Grid::interpolate (const math::Vector2 &v) const
{
  unsigned int x[2];
  (this->*_lookup) (x, v);
...
math::Vector2
Grid::interpolate_deriv (const math::Vector2 &v) const
{
  math::Vector2 res;
  unsigned int x[2];
  (this->*_lookup) (x, v);
...
void
Grid::set_metrics (const math::Vector2 &origin, const math::Vector2 &step)
{
  invalidate ();
  _origin = origin;
  _step = step;
...
void
Grid::resize (unsigned int n1, unsigned int n2)
{
  (this->*_resize) (n1, n2);
  _size[0] = n1;
  _size[1] = n2;
...
unsigned int
Grid::get_dimensions () const
{
  return 2;
}

unsigned int
Grid::get_count (unsigned int dimension) const
{
