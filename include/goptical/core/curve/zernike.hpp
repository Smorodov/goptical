...
void
Zernike::set_radius (double radius)
{
  _radius = radius;
}

double
Zernike::get_radius () const
{
  return _radius;
}

void
Zernike::set_coefficient (unsigned int n, double c)
{
  assert (n < term_count);
  _coeff[n] = c;
...
double
Zernike::get_coefficient (unsigned int n) const
{
  assert (n < term_count);
  return _coeff[n];
}
...
void
Zernike::set_coefficients_threshold (double t)
{
  _threshold = t;
...
void
Zernike::set_coefficients_scale (double s)
{
  _scale = s;
}
}
