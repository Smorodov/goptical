...
public:
  ...
  virtual double get_internal_transmittance (double wavelen,
  ...
  virtual double get_normal_reflectance (const Base *from,
                                         double wavelen) const;

  /** Get transmittance at normal incidence */
  virtual double get_normal_transmittance (const Base *from,
                                           double wavelen) const;
...
double
Base::get_refractive_index (double wavelen, const Base &env) const
{
