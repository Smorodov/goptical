...
int main() {
  ...
  lens.add_surface(ref<AsphericCurve>::create(52.8577, 0.5721, 1.10084e-07,
                                              6.21998e-10, -4.25694e-13),
                   ref<shape::Disk>::create(24.765), 6.0,
                   ref<material::AbbeVd>::create(1.744430, 49.53));
  ...
  lens.add_surface(ref<AsphericCurve>::create(-77.2943, 14.1597, 8.65514e-06,
                                              4.1594e-09, 1.25812e-11,
                                              1.22728e-14),
                   ref<shape::Disk>::create(17.06), 38.7);

  auto &s1 = lens.get_surface(0);

  double image_pos = 6.0 + 0.1 + 6.0 + 1.5 + 4.1038 + 1.5 + 6.0 + 6.0 + 1.7 +
                     7.0 + 0.1 + 6.0 + 1.5 + 6.0 + 38.7;
  ...
  //                                math::Vector3(0, 0, 1));
  sys::SourcePoint source_point(sys::SourceAtInfinity, math::Vector3(0, .2, 1));
  ...
  //  {
  //    /* anchor spot */
  //    io::RendererSvg            renderer("spot2.svg",        300 * 3, 300 *
  //    2, io::rgb_black);
  //
