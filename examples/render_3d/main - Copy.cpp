...
//
//--------------------------------------------------------------------------
    float vetexNormals[] ={0,0,1, 0,0,1, 0,0,1 }  ;
    float vertices_data[] =  {-0.1,-0.1,0,
        0.1,-0.1,0,
        -0.1,0.1,0 }  ;
    GLuint faceIndices[] =  {2,1,0}  ;
    GLuint vertex_num=3;
    GLuint face_index_num=1;

void display(void)
{


    //normalsComputer->getVertexNormals( vertex_num * 3, vertices_data, vetexNormals);
