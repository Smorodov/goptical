...
{
	glutSolidCone(orad,orad,slices,stacks);            /* orad doubles as size input */
}
static void drawWireCone(void)
{
	glutWireCone(orad,orad,slices,stacks);             /* orad doubles as size input */
}
static void drawSolidCylinder(void)
{
	glutSolidCylinder(orad,orad,slices,stacks);        /* orad doubles as size input */
}
static void drawWireCylinder(void)
{
	glutWireCylinder(orad,orad,slices,stacks);         /* orad doubles as size input */
}
...
key(unsigned char key, int x, int y)
{
	switch (key)
	{
		...
		case 'I':
		case 'i':
			show_info = ( show_info == GL_TRUE ) ? GL_FALSE : GL_TRUE;
			break;
		case '=':
		case '+':
			slices++;
