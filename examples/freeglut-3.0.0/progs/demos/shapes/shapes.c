...
{
	glutSolidCube(orad);                               /* orad doubles as size input */
}
static void drawWireCube(void)
{
	glutWireCube(orad);                                /* orad doubles as size input */
}
...
{
	glutSolidSierpinskiSponge (depth, offset, orad);   /* orad doubles as size input */
}
static void drawWireSierpinskiSponge(void)
{
	glutWireSierpinskiSponge (depth, offset, orad);    /* orad doubles as size input */
}
...
{
	glutSolidSphere(orad,slices,stacks);               /* orad doubles as size input */
}
static void drawWireSphere(void)
{
	glutWireSphere(orad,slices,stacks);                /* orad doubles as size input */
}
static void drawSolidCone(void)
{
	glutSolidCone(irad,orad,slices,stacks);            /* irad doubles as base input, and orad as height input */
}
static void drawWireCone(void)
{
	glutWireCone(irad,orad,slices,stacks);             /* irad doubles as base input, and orad as height input */
}
static void drawSolidCylinder(void)
{
	glutSolidCylinder(irad,orad,slices,stacks);        /* irad doubles as radius input, and orad as height input */
}
static void drawWireCylinder(void)
{
	glutWireCylinder(irad,orad,slices,stacks);         /* irad doubles as radius input, and orad as height input */
}
...
{
	glFrontFace(GL_CW);
	glutSolidTeapot(orad);
	glFrontFace(GL_CCW);    /* orad doubles as size input */
}
...
{
	glFrontFace(GL_CW);
	glutSolidTeaspoon(orad);
	glFrontFace(GL_CCW);    /* orad doubles as size input */
}
static void drawWireTeaspoon(void)
{
	glFrontFace(GL_CW);
	glutWireTeaspoon(orad);
	glFrontFace(GL_CCW);    /* orad doubles as size input */
}
...
key(unsigned char key, int x, int y)
{
	switch (key)
	{
		...
		case 'P':
		case 'p':
			persProject=!persProject;
			break;
		case 'R':
		case 'r':
			animateXRot=!animateXRot;
			break;
		case 'S':
		case 's':
			useShader=!useShader;
