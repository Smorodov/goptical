...
RendererDxf::RendererDxf (const char *filename)
    : _filename (filename), _group_level (0), _model (), _current_block (0),
      _layer_id (0)
{
  init ();
}
...
RendererDxf::RendererDxf ()
    : _filename (0), _group_level (0), _model (), _current_block (0),
      _layer_id (0)
{
  init ();
}
...
unsigned int
RendererDxf::add_layer (std::string name)
{
...
void
RendererDxf::add_entity (dimeEntity *entity)
{
...
void
RendererDxf::write (const std::string &filename)
{
  dimeOutput out;
...
void
RendererDxf::group_begin (const std::string &name)
{
  if (_group_level++)
    return;
...
void
RendererDxf::draw_point (const math::Vector2 &p, const Rgb &rgb,
                         enum PointStyle s)
{
...
void
RendererDxf::draw_segment (const math::VectorPair2 &l, const Rgb &rgb)
{
...
void
RendererDxf::draw_circle (const math::Vector2 &c, double r, const Rgb &rgb,
                          bool filled)
{
...
void
RendererDxf::draw_text (const math::Vector2 &pos, const math::Vector2 &dir,
...
void
RendererDxf::draw_text (const math::Vector3 &pos, const math::Vector3 &dir,
                        const std::string &str, TextAlignMask a, int size,
                        const Rgb &rgb)
{
  // FIXME
...
void
RendererDxf::draw_point (const math::Vector3 &p, const Rgb &rgb,
                         enum PointStyle s)
{
  dimePoint *point = new dimePoint;
...
void
RendererDxf::draw_segment (const math::VectorPair3 &l, const Rgb &rgb)
{
  dimeLine *line = new dimeLine;
