...
unsigned int
Lens::add_surface (double roc, double radius, double thickness,
                   const std::shared_ptr<material::Base> &glass)
{
...
void
Lens::add_stop (const std::shared_ptr<shape::Base> &shape, double thickness)
{
  if (_stop)
...
void
Lens::add_stop (double radius, double thickness)
{
