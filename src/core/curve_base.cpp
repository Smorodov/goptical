...
bool
Base::intersect (math::Vector3 &point, const math::VectorPair3 &ray) const
{
  math::VectorPair3 p;
...
static double
gsl_func_sagitta_x (double x, void *params)
{
...
static double
gsl_func_sagitta_y (double y, void *params)
{
  struct curve_gsl_params_s *p = (struct curve_gsl_params_s *)params;
...
void
Base::derivative (const math::Vector2 &xy, math::Vector2 &dxdy) const
{
  double abserr;
...
void
Base::normal (math::Vector3 &normal, const math::Vector3 &point) const
{
  math::Vector2 d;
