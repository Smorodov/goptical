...
void
Result::set_generated_save_state (const sys::Element &e, bool enabled)
{
  init (e);
...
bool
Result::get_intercepted_save_state (const sys::Element &e)
{
  return get_element_result (e)._save_intercepted_list;
}

bool
Result::get_generated_save_state (const sys::Element &e)
{
  return get_element_result (e)._save_generated_list;
}

math::VectorPair3
Result::get_intercepted_window (const sys::Surface &s) const
{
