...
Dielectric::Dielectric ()
    : Solid ("dielectric"), _transmittance (), _temp_model (ThermalNone),
      _low_wavelen (350.0), _high_wavelen (750.0),
      _measurement_medium (std_air), _last_wavelen (0)
{
  _transmittance.set_interpolation (data::Cubic);
}

bool
Dielectric::is_opaque () const
{
  return false;
}

bool
Dielectric::is_reflecting () const
{
  return false;
}

double
Dielectric::get_internal_transmittance (double wavelen, double thickness) const
{
...
void
Dielectric::set_internal_transmittance (double wavelen, double thickness,
...
double
Dielectric::get_internal_transmittance (double wavelen) const
{
  try
    {
...
double
Dielectric::get_schott_temp (double wavelen, double n) const
{
...
double
Dielectric::get_refractive_index (double wavelen) const
{
...
double
Dielectric::get_principal_dispersion () const
{
...
double
Dielectric::get_partial_dispersion (double wavelen1, double wavelen2) const
{
